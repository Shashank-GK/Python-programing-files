...
dict2 = dict(
    ((1, 2), (3, 4), (4, 5))
)  # creating the Dictionary using iterables (Ex: tuples)
print(dict2)

dict3 = dict(
    ([1, 2], [3, 4], [4, 5])
)  # creating the Dictionary using iterables (Ex: lists)
print("Dict3", dict3)
...
dict5 = dict(
    enumerate(l2)
)  # creating the dictionary using 'enumerate' keyword using lis l1
print(dict5)
